  ...
  <div class="common-layout">
    ...
    <el-scrollbar height="95vh">
      ...
      <div class="imageLi">
        ...
        >
          <el-image
            :class="[ActionImage === item.id ? 'showImgAction' : 'showImg']"
            :src="item.img"
            fit="fill"
          />
        </div>
      ...
      <div>
        <div class="transparent">
          <p>
            选择尺码<span v-if="SizeNumber" style="margin-left: 10px"
              >库存:{{ SizeNumber }}</span
            >
          </p>
          <p>尺码表</p>
      ...
      <div class="textMain">
        穿上温暖多绒的 Jordan Essential Winter
        男子加绒连帽衫，让你轻松应对冷天。刺绣 AIR JORDAN
        字样，打造舒适穿着体验，又不失潮酷感。
      </div>
    </el-scrollbar>
  </div>
